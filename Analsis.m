...
D=[0:1/n:1];
figure(29),mesh(D,D,ISE);colormap([0 0 0]);axis tight
title('Superficie ISE en función de \lambda_{1} y \lambda_{2}','FontSize',16),xlabel('Parámetro \lambda_{1}','FontSize',12),
ylabel('Parámetro \lambda_{2}','FontSize',12),zlabel('Valor ISE','FontSize',12)
...
D=[0:1/n:1];
figure(37),mesh(D,D,ITSE);colormap([0 0 0]);axis tight
title('Superficie ITSE en función de \lambda_{1} y \lambda_{2}','FontSize',16),xlabel('Parámetro \lambda_{1}','FontSize',12),
ylabel('Parámetro \lambda_{2}','FontSize',12),zlabel('Valor ITSE','FontSize',12)
...
%plot(SUBD(SUBV),Co(SUBV,5),'m*','LineWidth',2);
...
%plot(linspace(1,Ts,size(Co,1))',Co(:,5),'m','LineWidth',1);

%plot(linspace(1,Ts,size(Co,1))',Co(:,6),'LineWidth',2);

legend(num2str(CC(1:end,:)),'Location','SouthEast');
